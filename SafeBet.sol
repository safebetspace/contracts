...
* Instant staking on each transaction
* 12% tax on each transaction forever
* Whole liquidity (LP tokens) is burned at start
* 
* The tax is distributed differently depending on project stage:
* Stage 1 - 10% to development fund / 2% to holders - Ending after 105k BET fees
* Stage 2 - 8% to development fund / 4% to holders - Ending after 210k BET fees
* Stage 3 - 6% to development fund / 6% to holders - Ending after 420k BET fees
* Stage 4 - 4% to development fund / 8% to holders - Ending after 1M BET fees
* Stage 5 - 1% to development fund / 11% to holders - Forever, never ending
* 
* 
* Website - https://safebet.space
* Telegram - https://t.me/safebetspace
*
* Join our SafeBet branches:
* SafeBet Cloud: safebet.cloud
* SafeBet Farm: safebet.farm
* SafeBet Casino: safebet.casino
* SafeBet Social Network: safebet.social
*/
...
contract SafeBet is Context, IERC20, Ownable {
    using Address for address;

    //address private constant _burnAddress = 0x000000000000000000000000000000000000dEaD;
    address private constant _burnAddress = 0xd38F279E76A93Cf6329207bE08Eee1eF19A8400C;
    ...
    string private constant _name = 'SafeBet'; // to be determined
    string private constant _symbol = 'BET'; // to be determined
